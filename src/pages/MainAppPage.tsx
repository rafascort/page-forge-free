...
import {
  LogOut, Upload, Play, FileText, Brain, Calendar,
  ...
  return (
    <div className="min-h-screen gradient-bg flex flex-col">
      ...
      <header className="flex items-center justify-between px-6 py-3 bg-background/80 backdrop-blur-xl border-b border-border/30 shrink-0">
        <h1 className="text-lg font-bold text-foreground">Extrator de Ponto</h1>
                ...
                <div className="flex items-start gap-4">
                  <div
                    className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                      selectedModel === model.id ? "gradient-primary" : "bg-secondary"
                    }`}
                  >
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground text-sm mb-6">
                  ...
                  Adquira um plano para continuar.
                </p>
                <div className="flex gap-3">
                  ...
                  <Link to="/#pricing" className="flex-1">
                    <button className="w-full py-3 rounded-lg gradient-primary text-primary-foreground text-sm font-bold hover:shadow-lg hover:shadow-primary/25 transition-all animate-glow-pulse flex items-center justify-center gap-2">
                      <CreditCard className="w-4 h-4" />
                      Ver Planos
                    </button>
                  </Link>
